...
import { Gem, Loader2, Clock, LayoutDashboard, ShieldCheck } from 'lucide-react';
...
export default function HomePage() {
  const { address, isConnected, isLoading, actorInfo, isAdmin, connect, refreshActorInfo } = useWallet();
  ...
  if (!isConnected) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-3.5rem)] px-4 text-center">
        <Gem className="size-16 text-primary mb-6" />
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-3.5rem)] px-4 text-center">
      <Gem className="size-12 text-primary mb-4" />
